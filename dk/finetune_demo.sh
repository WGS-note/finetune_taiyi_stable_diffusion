...
docker run -d --gpus '"device=2"' \
       --rm -it --name text2image_finetune_demo \
       --shm-size 12G \
       -v /data/wgs/text2img:/home \
       wgs-torch:3.0 \
       sh -c "python3 -u /home/finetune/finetune_demo.py $options 1>>/home/log/finetune_demo.log 2>>/home/log/finetune_demo.err"

# nohup sh /data/wgs/text2img/dk/finetune.sh &
# nohup sh /data/wgs/text2img/dk/finetune_demo.sh &
